...
public class MediaMovelPonderadaTest {
	...
	public void sequenciaSimplesDeCandles() {
		...
		Assert.assertEquals(14.0 / 6, mmp.calcula(2, serie), 0.0000001);
		Assert.assertEquals(20.0 / 6, mmp.calcula(3, serie), 0.0000001);
		Assert.assertEquals(26.0 / 6, mmp.calcula(4, serie), 0.0000001);
		Assert.assertEquals(32.0 / 6, mmp.calcula(5, serie), 0.0000001);
